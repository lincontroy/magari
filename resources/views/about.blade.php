        ...
        <div class="row align-items-center">				
            ...
            <div class="col-lg-6" data-aos="fade-down">
                <div class="about-content">
                    ...
                    <p>We are a reputable car rental company committed to providing excellent service and making car rental experience convenient and enjoyable for our customers.</p>
                    <p>Our mission is to offer top-notch car rental solutions tailored to meet your travel needs.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <ul>
...
<section class="section facts-number">
    ...
    <div class="container">
        ...
        <div class="section-heading" data-aos="fade-down">
            ...
            <p class="description text-white">Get to know us better through these numbers.</p>
        </div>
        <!-- /Heading title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
                    <div class="count-group flex-fill">
                        <div class="customer-count d-flex align-items-center">
                            ...
                            <div class="count-content">
                                <h4><span class="counterUp">24/7</span></h4>
                ...
                <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down">
                    <div class="count-group flex-fill">
                        <div class="customer-count d-flex align-items-center">
                            <div class="count-img">
                                <img src="assets/img/icons/bx-buildings.svg" alt="Icon">
                            </div>
                            <div class="count-content">
